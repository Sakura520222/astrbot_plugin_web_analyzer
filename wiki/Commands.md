...
**命令格式：** `/web_browser [action]`

**功能：** 管理插件自动安装的 Playwright 浏览器
...
**可用操作：**
- 无参数：查看浏览器安装和运行状态
- `uninstall`：卸载浏览器（关闭所有浏览器实例、删除浏览器文件、清理安装状态）
...
/浏览器管理
# 卸载浏览器
/web_browser uninstall
```

**注意事项：**
- 卸载浏览器后将无法使用截图功能，直到下次自动重新安装
- 如果浏览器正在安装中，无法执行卸载操作
- 卸载会关闭所有浏览器实例并删除浏览器安装目录
