...
> **TIP**
> 为了方便开发，您可以使用 AstrBot Text2Image Playground 在线可视化编辑和测试 HTML 模板。
...
![文转图示例](https://via.placeholder.com/400x200?text=text+to+image)
...
![todo list example](https://via.placeholder.com/400x200?text=todo+list)
