...
![平台列表](https://via.placeholder.com/400x200?text=platform+list)

这里出现了我们创建的 fake。

![配置页面](https://via.placeholder.com/400x200?text=config+page)

启动后，可以看到正常工作：

![运行结果](https://via.placeholder.com/400x200?text=running)
